" I've hacked the default menu/toolbar by moving
" /Applications/MacVim.app/Contents/Resources/vim/runtime/menu.vim to
" menu.vim.orig, and symlinking menu.vim to this file. If there's a better
...
if has("toolbar")
  ...
  "}}}
  "cut/copy/paste
  vnoremenu icon=/Users/nickca/.vim/bitmaps/cut.png 1.10 ToolBar.Cut		"+x
  vnoremenu icon=/Users/nickca/.vim/bitmaps/copy.png 1.15 ToolBar.Copy		"+y
  cnoremenu icon=/Users/nickca/.vim/bitmaps/copy.png 1.20 ToolBar.Copy		<C-Y>
  nnoremenu icon=/Users/nickca/.vim/bitmaps/paste.png 1.25 ToolBar.Paste		"+gP
  cnoremenu	 ToolBar.Paste		<C-R>+
  exe 'vnoremenu <script>	 ToolBar.Paste	' . paste#paste_cmd['v']
  exe 'inoremenu <script>	 ToolBar.Paste	' . paste#paste_cmd['i']
  an 1.30 ToolBar.-sep1-		<Nop>
  "undo/redo
  an icon=/Users/nickca/.vim/bitmaps/undo.png 1.35 ToolBar.Undo			u
  an icon=/Users/nickca/.vim/bitmaps/redo.png 1.40 ToolBar.Redo			<C-R>
  an 1.50 ToolBar.-sep2-		<Nop>
  "everything after here is added from gvimrc
